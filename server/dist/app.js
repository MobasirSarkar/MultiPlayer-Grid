...
const grid_routes_1 = __importDefault(require("./routes/grid.routes"));
...
app.use("/api/grid", grid_routes_1.default);
...
app.use((err, req, res, next) => {
    ...
    res.status(500).json({
        ...
        message: env_1.NODE_ENV === "development" ? err.message : undefined,
    });
});
exports.default = app;
